    ...
    var win = void 0, raf = (win = "undefined" != typeof window ? window : "undefined" != typeof self ? self : {}).requestAnimationFrame || win.webkitRequestAnimationFrame || win.mozRequestAnimationFrame || win.oRequestAnimationFrame || win.msRequestAnimationFrame || function(callback) {
        ...
        function Grid(props) {
            ...
            _this._styleCache = {}, _this._cellCache = {}, _this._debounceScrollEndedCallback = function() {
                ...
                event.target === _this._scrollingContainer ? _this.handleScrollEvent(event.target) : console.log("target not right");
            };
        ...
        return inherits(Grid, _React$PureComponent), createClass(Grid, [ {
            ...
            key: "_invokeOnScrollMemoizer",
            value: function(_ref6) {
                var scrollLeft = _ref6.scrollLeft, scrollTop = _ref6.scrollTop, totalColumnsWidth = _ref6.totalColumnsWidth, totalRowsHeight = _ref6.totalRowsHeight, _props7 = this.props, height = _props7.height;
                (0, _props7.onScroll)({
                    clientHeight: height,
                    ...
                    callback: function(_ref7) {
                        _ref7.scrollLeft, _ref7.scrollTop;
                    },
                    indices: {
                        scrollLeft: scrollLeft,
                        scrollTop: scrollTop
